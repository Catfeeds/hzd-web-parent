...
<form name="userForm1" action="/api/100/onlineLoanapply/ImgUpload/123456" enctype="multipart/form-data" method="post">
    <div id="newUpload1">
...
<form name="userForm2" action="http://localhost:8080/api-hzd/api/100/onlineLoanapply/ImgUpload/123456" enctype="multipart/form-data" method="post">
<div id="newUpload2">
    <input type="file" name="file">
