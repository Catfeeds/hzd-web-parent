 ...
 * @author 作者:pgx E-mail:pgx89112@163.com Tel:13241706779
 * @date 创建时间：2016年6月30日 上午11:32:51 
 * @version 1.0 
 * @since  JDK1.8
 */
public class HttpTool {
    ...
    private static final int MAX_TIMEOUT = 7000;//连接超时时间7秒
    static {
        // 设置连接池
...
//            logger.info(response.toString());
    ...
    public static String sendPostJson(String apiUrl, Object json) {
        ...
        try {
            ...
            response = httpClient.execute(httpPost);
            HttpEntity entity = response.getEntity();
//            logger.info("Object@@@@@@@@@@@@@@@@@"+response.getStatusLine().getStatusCode());
            httpStr = EntityUtils.toString(entity, "UTF-8");
//            logger.info("Object&&&&&&&&&&&&&"+httpStr);
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
            if (response != null) {
