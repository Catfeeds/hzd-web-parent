...
public class LogAspect {
    ...
    @Before("@within(com.hzcf.platform.api.annotation.LogAnnotation)")
    public void beforeType(JoinPoint joinPoint) {
        before(joinPoint);
    }

    @Before("@annotation(com.hzcf.platform.api.annotation.LogAnnotation)")
    ...
    @AfterReturning(value = "@within(com.hzcf.platform.api.annotation.LogAnnotation)", returning = "result")
    public void afterReturningType(JoinPoint joinPoint, Object result) {
        afterReturning(joinPoint, result);
    }

    @AfterReturning(value = "@annotation(com.hzcf.platform.api.annotation.LogAnnotation)", returning = "result")
    ...
    @AfterThrowing(value = "@within(com.hzcf.platform.api.annotation.LogAnnotation)", throwing = "ex")
    public void afterThrowingType(JoinPoint joinPoint, Throwable ex) {
        afterThrowing(joinPoint, ex);
    }

    @AfterThrowing(value = "@annotation(com.hzcf.platform.api.annotation.LogAnnotation)", throwing = "ex")
