...
$(function() {
	...
	tabCloseEven();
		 ...
		 * 
		 * var src = iframe.attr('src'); if(src) $('#tabs').tabs('update', {
...
function InitLeftMenu() {
	...
	$.each(_menus.menus, function(i, n) {
		...
		$.each(secondMenus, function(j, o) {
					menulist += '<li><div ><a ref="' + o.menuId
							//+ '" href="#" rel="' + o.url
							+ '" href="'+ o.url+'" rel="' + o.url
		...
		$('#nav').accordion('add', {
			...
			iconCls : 'icon ' + n.icon,
			selected : false
				// 左边树形菜单中默认不打开第3级菜单的最后一个菜单 2012.11.20 暂时注掉
			});
	...
	// 左边树形菜单中默认打开第3级菜单的第一个菜单 2012.11.20 暂时注掉
