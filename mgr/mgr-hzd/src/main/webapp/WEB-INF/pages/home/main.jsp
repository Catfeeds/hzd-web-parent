...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="font-size: 14px;float:right; padding-right:20px;" class="head">
        	...
        	<a href="javascript:void(0)" onclick="resetPassword();"
               style="padding-right:20px;color:#FFF; text-decoration:none;">修改密码</a>
        </span>
...
<div data-options="region:'west',href:''" title="导航" style="width: 200px; padding: 10px;">
    <ul id="mainMenu" class="easyui-tree">
        <li>
            <span>线上进件</span>
            <ul>
                <li><span><a href="javascript:void(0)" onclick="addTab('进件列表', '${path}/apply/list')">进件列表</a></span>
                </li>
            </ul>
        </li>
        ...
        <li>
            <span>用户管理</span>
            <ul>
                <li><span><a href="javascript:void(0)" onclick="addTab('用户列表', '${path}/users/list')">用户列表</a></span>
                </li>
            </ul>
        </li>
        ...
        <li>
            <span>实名认证管理</span>
            <ul>
                <li><span><a href="javascript:void(0)" onclick="addTab('实名认证列表', '${path}/users/check/list')">实名认证列表</a></span>
                </li>
            </ul>
        </li>
