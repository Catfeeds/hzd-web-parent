...
public class CookieUtil {
	...
	public static void setCookie(HttpServletRequest request, HttpServletResponse response, String name, String value) {
		...
		setCookie(request,response,name,value,StringUtils.isBlank(ctx) ? "/" : ctx, null ,DEFAULT_COOKIE_TIME);
	}
	
	public static void setCookie(HttpServletRequest reqest, HttpServletResponse response, String name,
	...
	public static void deleteAllCookies(HttpServletRequest request,
		...
		for (Cookie ck : cooks){
			deleteCookie(response, ck, StringUtils.isBlank(ctx) ? "/" : ctx);
		}
	}
