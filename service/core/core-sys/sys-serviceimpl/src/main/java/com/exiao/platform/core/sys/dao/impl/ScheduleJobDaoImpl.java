...
import com.exiao.platform.core.sys.dao.ScheduleJobDao;
...
public class ScheduleJobDaoImpl extends MysqlGenericDAO<ScheduleJob>implements ScheduleJobDao {
	...
	public List<ScheduleJob> getCollecion() {
		...
		List<ScheduleJob> list = sqlSessionTemplate.selectList("com.exiao.platform.core.sys.data.ScheduleJob.getAll");
		return list; 
	}
	...
	public boolean update(ScheduleJob scheduleJob) {
		...
		if (scheduleJob != null && scheduleJob.getId() > 0) {
			sqlSessionTemplate.update("com.exiao.platform.core.sys.data.ScheduleJob.updateByIdSelective", scheduleJob);
		}
		return true;
	}
	...
	public ScheduleJob getScheduleJobById(String id) {
		// TODO Auto-generated method stub
		ScheduleJob job = (ScheduleJob) sqlSessionTemplate.selectOne("com.exiao.platform.core.sys.data.ScheduleJob.selectById", id);
		return job;
	}
