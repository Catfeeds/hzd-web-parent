...
public class UserDaoImpl extends MysqlGenericDAO<User> implements UserDao {
	...
	final static String mapperStr = "User";

	@Override
	public List<User> getCollecion() {
		// TODO Auto-generated method stub
		List<User> list = sqlSessionTemplate.selectList("User.getAll");
		return list;
	}
	...
	public User getUserByID(String id) {
		// TODO Auto-generated method stub
		User user = (User) sqlSessionTemplate.selectOne("User.queryById", Integer.valueOf(id));
		return user;
	}
	...
	public List<User> getUserListByIds(Long... ids) {
		// TODO Auto-generated method stub
		List<User> list = sqlSessionTemplate.selectList("User.getUserListByIds", ids);
		return list;
	}
