...
import com.exiao.platform.core.sys.dao.MetaElementDao;
...
public class MetaElementDaoImpl extends MysqlGenericDAO<MetaElement> implements MetaElementDao{
	...
	public MetaElement getMetaElementByID(String id) {
		// TODO Auto-generated method stub
		MetaElement  element= (MetaElement) sqlSessionTemplate.selectOne("com.exiao.platform.core.sys.data.MetaElement.queryById", Integer.valueOf(id));
		return element;
	}
	...
	public List<MetaElement>  getMetaElementByParam(String dataName, String dataCode) {
		...
		List<MetaElement> list = sqlSessionTemplate.selectList("com.exiao.platform.core.sys.data.MetaElement.selectList",param);
		return list;
	}
