...
import com.exiao.platform.core.sys.dao.SysRolePermissionDao;
...
@Repository
public class SysRolePermissionDaoImpl extends MysqlGenericDAO<SysRolePermission>implements SysRolePermissionDao {

	private Logger logger = LoggerFactory.getLogger(this.getClass());
	String mapperStr = "com.exiao.platform.core.sys.data.SysRolePermission.";
	...
	public List<SysRolePermission> getSysRolePermissionByRoleId(Long roleId) {
		...
		List<SysRolePermission> list = sqlSessionTemplate
				.selectList("com.exiao.platform.core.sys.data.SysRolePermission.selectByRoleIdList",roleId);
		return list;
	}
	...
	public boolean delete(Long id) {
		// TODO Auto-generated method stub
		int result = sqlSessionTemplate.delete("com.exiao.platform.core.sys.data.SysRolePermission.deleteById", id);
		if (result > 0) {
			return true;
		} else {
			return false;
