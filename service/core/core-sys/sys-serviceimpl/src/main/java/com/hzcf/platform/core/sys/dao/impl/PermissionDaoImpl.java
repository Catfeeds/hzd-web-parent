...
public class PermissionDaoImpl extends AbstractMysqlBaseDaoImpl<Permission> implements PermissionDao{
	...
	String mapperStr = "Permission.";

	@Override
	public List<Permission> getCollecion() {
		// TODO Auto-generated method stub
		List<Permission> list = sqlSessionTemplate.selectList("Permission.getAll");
		return list;
	}
	...
	public Permission getPermissionByID(String id) {
		// TODO Auto-generated method stub
		Permission permission = (Permission) sqlSessionTemplate.selectOne("Permission.queryById", Integer.valueOf(id));
		return permission;
	}
	...
	public List<Permission> getPermissionCollecion(Integer user_id) {
		// TODO Auto-generated method stub
		List<Permission> list = sqlSessionTemplate.selectList("Permission.getListByUserId",user_id);
		return list;
	}
	...
	public List<Permission> getCollecion(Integer role_id) {
		// TODO Auto-generated method stub
		List<Permission> list = sqlSessionTemplate.selectList("Permission.getListByRoleId",role_id);
		return list; 
	}
	...
	public List<Permission> getPermissionListByUserCode(String userCode) {
		// TODO Auto-generated method stub
		List<Permission> list = sqlSessionTemplate.selectList("Permission.getListByUserloginName",userCode);
		return list; 
	}
